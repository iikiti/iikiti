...
abstract class DynamicBackedEnumerator extends DynamicEnumerator implements DynamicBackedEnumInterface
{
	...
	/**
	 * Hook for subclasses to validate the value before registration.
	 *
	 * The default implementation is a no-op. Subclasses (e.g. UserRoleEnum)
	 * override this to enforce naming conventions.
	 */
